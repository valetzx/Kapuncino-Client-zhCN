    ...
    void on(coffee.client.helper.event.impl.MouseEvent me) {
        if (me.getButton() == 1) {
            ...
            if (sex.getItem() instanceof SpawnEggItem) {
                ...
                BlockHitResult bhr = new BlockHitResult(CoffeeMain.client.player.getPos(), Direction.DOWN, new BlockPos(BlockPos.ofFloored(CoffeeMain.client.player.getPos())), false);
